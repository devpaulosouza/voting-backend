...
public interface InsufficientAuthenticationExceptionAdviceTrait extends AdviceTrait {

	Logger log = LoggerFactory.getLogger(InsufficientAuthenticationExceptionAdviceTrait.class);

	URI TYPE = URI.create("https://paulosouza.dev/forbidden");
